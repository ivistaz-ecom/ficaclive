      ...
      {isData.length > 0 && (
        <Container fluid className='wbg-light p-4 px-2 pb-5'>
          <Container>
            ...
            <h3 className="fs-1 txt-dark text-center py-3">Upcoming Events</h3>
                      ...
                      <div className="card border-0">
                        ...
                        {post.acf.excerpt && (
                          <div className="text-center">
                            <p className="card-text fs-6 fw-300 py-4">{post.acf.excerpt}</p>
                          </div>
                        )}
                        <div>
                          {post.content.rendered && (
                            <Col className='py-4 text-center'>
                              <Link href={`/upcoming-events/${post.slug}`} target='_blank'>
                                <p className='rounded-2 py-2 px-3 d-inline-block text-white mb-0' style={{ backgroundColor: "#001C79" }}>
                                  Read More
                                </p>
                              </Link>
                            </Col>
